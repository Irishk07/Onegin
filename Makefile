...
CPPFLAGS := -D _DEBUG -ggdb3 -std=c++17 -O0 -Wall -Wextra -Weffc++ -Waggressive-loop-optimizations -Wc++14-compat \
...
-fstrict-overflow -flto-odr-type-merging -fno-omit-frame-pointer -Wlarger-than=81920 -Wstack-usage=81920 -pie -fPIE -Werror=vla \
...
CPPSRC := main.cpp string_functions.cpp read_and_fill.cpp sort_swap.cpp ctor_dtor.cpp put_in_file.cpp
